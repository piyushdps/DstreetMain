...
import AdminOrdersToday from "./AdminOrdersToday";
  ...
  return (
    <Router>
      ...
      >
        ...
        <Route path="/kitchen">
          <Kitchen loginHandler={loginHandler} />
        </Route>
        <Route path="/adminorderstoday">
          <AdminOrdersToday loginHandler={loginHandler} />
        </Route>
        ...
        <Route path="/login">
          <Login loginHandler={loginHandler} redirectTo="/"  logoutHandler={logoutHandler}/>
        </Route>
        <Route path="/signup">
