...
function Navbar({ isAdmin, isLoggedIn, user, logoutHandler }) {
  ...
  useEffect(() => {
  if(isAdmin){
    var pusherClient = new Pusher('f4c8722152b206bd3a33', {
      cluster: 'ap2'
    });
    ...
    >
      ...
      >
        <div className="navbar-start">
         ...
         {!isAdmin && <Link className="navbar-item button is-light mx-2 mt-2" to="/info">
            <FA name="info" />
          ...
          {isAdmin && (
           ...
           {isAdmin && (
            <Link
              className="navbar-item button is-light is-inverted mx-2 mt-2"
              to="/kitchen"
            >
